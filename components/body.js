    ...
    <main className="my-3  px-2 ">
      <section className="w-full flex flex-col ">
        ...
        <div className="my-2 mt-20  pt-4 w-full md:w-4/5 px-6  py-2 md:h-[400px] m-auto  flex flex-col md:flex-row gap-4  mb-4">
          ...
          <div className=" relative w-1/2 h-full border border-gray-200 rounded-md bg-white ">
            <Image
              src="/image/alton.jpg"
              alt="alton"
              loading="lazy"
      ...
      <section className="w-full h-[400px]">
        <div className="w-[490px] h-3/4 m-auto mt-7 text-3xl text-gray-700 bg-gray-50 flex items-center">
